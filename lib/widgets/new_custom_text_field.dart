...
class NewCustomTextField extends StatefulWidget {
  ...
  final _state = _NewCustomTextFieldState();

  @override
  _NewCustomTextFieldState createState() {
    return _state;
  }
    ...
    return _fieldContainer(
      TextFormField(
        ...
        decoration: InputDecoration(
            ...
            contentPadding:
                EdgeInsets.only(top: 8.h, bottom: 8.h, left: 15.w),
  ...
  Widget _fieldContainer(Widget child) {
    return Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
              color: widget.errorText.isEmpty ? Colors.transparent : Colors.red,
            ),
            boxShadow: [
              BoxShadow(
        ...
        child: Column(
          ...
          Padding(
            ...
            child: Text("name is required ", textAlign: TextAlign.end, style: TextStyle(color: Colors.red),),
          )
        ],));
  }
