...
class MyCostomTexttField extends StatefulWidget {
  final String? hint;
  final String? label;
  ...
  final _state = _MyCostomTexttFieldState();

  @override
  _MyCostomTexttFieldState createState() {
    return _state;
  }
...
class _MyCostomTexttFieldState extends State<MyCostomTexttField> {
  late bool _isHidden;
  String text = "";
    ...
    return
      ...
      TextFormField(
        ...
        decoration: InputDecoration(
            ...
            contentPadding: EdgeInsets.only(top: 21.h,bottom: 16.h,left: 15.w),
